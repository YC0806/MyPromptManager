...
export default function PromptDetail() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Modals */}
      <PublishModal open={showPublishModal} onClose={() => setShowPublishModal(false)} promptId={id} />
      <RollbackModal open={showRollbackModal} onClose={() => setShowRollbackModal(false)} promptId={id} />
    </div>
  )
}
