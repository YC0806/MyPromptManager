          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                <div className="absolute left-0 top-4 right-0 h-px bg-teal-200 dark:bg-teal-800"></div>
                <div className="flex items-start gap-4 overflow-x-auto pb-4">
                  <div className="sticky left-0 bg-gradient-to-br from-teal-50 via-emerald-50 to-cyan-50 dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950 pr-4 z-10">
                  ...
                  {releases.prod?.length === 0 && (
                    <div className="text-sm text-zinc-400 dark:text-zinc-500">No production releases</div>
                  )}
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                <div className="absolute left-0 top-4 right-0 h-px bg-zinc-200 dark:bg-zinc-700"></div>
                <div className="flex items-start gap-4 overflow-x-auto pb-4">
                  <div className="sticky left-0 bg-gradient-to-br from-teal-50 via-emerald-50 to-cyan-50 dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950 pr-4 z-10">
                  ...
                  {releases.beta?.length === 0 && (
                    <div className="text-sm text-zinc-400 dark:text-zinc-500">No beta releases</div>
                  )}
                </div>
              </div>
            </div>
...
function ReleaseCard({ release, channel }) {
  return (
    <Card className="w-64 flex-shrink-0 relative z-0 dark:bg-zinc-900 dark:border-zinc-800">
      <CardHeader>
