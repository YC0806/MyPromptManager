    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-8 py-12">
              ...
              <div className="space-y-4">
                {stats.recentActivity.map((activity) => {
                  ...
                  const getIconBg = (type) => {
                    switch(type) {
                      case 'template': return 'bg-purple-100 dark:bg-purple-900/30'
                  ...
                  return (
                    <div
                      key={activity.id}
                      className="flex items-center justify-between p-4 rounded-lg border dark:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors duration-200 cursor-pointer"
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="hover:shadow-md transition-shadow duration-200 dark:bg-zinc-900 dark:border-zinc-800">
            <CardHeader>
          ...
          <Card className="bg-gradient-to-br from-teal-500 to-emerald-500 dark:from-teal-600 dark:to-emerald-600 text-white hover:shadow-md transition-shadow duration-200">
            <CardHeader>
              <CardTitle className="text-white">Get Started</CardTitle>
              <CardDescription className="text-white/80 dark:text-white/70">
